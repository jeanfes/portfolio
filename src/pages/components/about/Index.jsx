    ...
    <section ref={rootRef} className={styles.root}>
      ...
      <div className={clsx(styles.container, 'layout-grid-inner')}>
        ...
        <div className={clsx(styles.descWrapper)} ref={animatedImageRef}>
          <AppearTitle>
            <div className="p-l">
              “Mi constante evolución como desarrollador
            </div>
            <div className="p-l">me permite resolver problemas complejos</div>
            <div className="p-l">
              de forma creativa, entregando código limpio
            </div>
        ...
        <div className={clsx(styles.descWrapperBottom)}>
          {!isMobile ? (
            <AppearTitle key="desktop-descWrapperBottom">
              <h6 className="h6">
                Soy un Ingeniero de Sistemas especializado en desarrollo
                Frontend
              </h6>
              <h6 className="h6">
                con React, TypeScript y React Native. Con 3 años de experiencia,
              </h6>
              <h6 className="h6">
                construyo interfaces accesibles y responsivas, optimizo el
                rendimiento
              </h6>
              <h6 className="h6">
                y trabajo en equipos ágiles entregando features con un fuerte
              </h6>
            ...
            <AppearTitle key="mobile-descWrapperBottom">
              <h6 className="h6">
                {' '}
                Soy un Ingeniero de Sistemas especializado en desarrollo
                Frontend con React, TypeScript y React Native. Con 3 años de
                experiencia, construyo interfaces accesibles y responsivas,
                optimizo el rendimiento y trabajo en equipos ágiles entregando
                features con un fuerte enfoque en UX y diseño interactivo.
              </h6>
            </AppearTitle>
          )}
